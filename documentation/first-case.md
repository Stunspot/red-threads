...
If you want a local copy, first [download and extract the skill](installation.md). Open a terminal in the extracted `red-threads` folder containing `SKILL.md`. These commands use its bundled example and create a new HTML file beside that extracted folder.
